...
PG_KEYWORD("chaining", CHAINING, UNRESERVED_KEYWORD)
...
PG_KEYWORD("json_table_primitive", JSON_TABLE_PRIMITIVE, COL_NAME_KEYWORD)
...
PG_KEYWORD("string", STRING, UNRESERVED_KEYWORD)
